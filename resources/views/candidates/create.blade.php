...
@section('content')
    <div class="container">
        <h2 class="mb-4">Tambahkan kandidat</h2>
        ...
        <form action="{{ route('candidates.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="vision" name="vision" rows="3" placeholder="Visi">{{ old('vision') }}</textarea>
                @error('vision')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="mission" name="mission" rows="3" placeholder="Misi">{{ old('mission') }}</textarea>
                @error('mission')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
